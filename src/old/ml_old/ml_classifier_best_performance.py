...
display_1 = ConfusionMatrixDisplay(confusion_matrix=confusion_matrix_1,
                                   display_labels=["gesture1", "gesture2", "gesture3"])
display_2 = ConfusionMatrixDisplay(confusion_matrix=confusion_matrix_2, display_labels=classifier_2.classes_)
display_1.plot()
display_2.plot()
plt.show()
dump(classifier_1, '../../joblib_files/ml_joblib_files/linearSVMClassifier.joblib')
dump(classifier_2, '../../joblib_files/ml_joblib_files/RandomForest.joblib')
